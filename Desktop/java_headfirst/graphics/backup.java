...
public class BeatBox2
{
	...
	public void setCheckBoxes(ArrayList<JCheckBox> data)
	{	check = true;
		checkboxList = new ArrayList<JCheckBox>();
		JCheckBox jc;
...
class CheckBoxData implements Serializable
	{
		ArrayList<JCheckBox> state = new ArrayList<JCheckBox>();
		...
		public ArrayList<JCheckBox> getData()
