...
public class AlgorithmBox3
{
	...
	public void loadList(int m) //m tells the sort by nature
	{
		...
		{	//always keep few names to ListNameAlgo to avoid error
			//File myFile = new File("ListAlgoName.txt");
			//System.out.println("Attempting to read from file in: "+myFile.getCanonicalPath());
			URL fileURL = this.getClass().getResource("in/ourpoems/algoBox/ListAlgoName.txt");
			File fireFile = new File(fileURL);

			InputStream is = this.getClass().getResourceAsStream("in/ourpoems/algoBox/ListAlgoName/ListAlgoName.txt");
			//BufferedReader reader = new BufferedReader(new FileReader(fireFile));
	...
	{	
		try{	File myFile = new File("ListAlgoName.txt");
				//URL fileURL = this.getClass().getResource("in/ourpoems/algoBox/ListAlgoName.txt");
				//File fireFile = new File(fileURL);
